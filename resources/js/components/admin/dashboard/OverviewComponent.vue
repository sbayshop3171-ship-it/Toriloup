<template>
    ...
    <div class="dashboard-overview mb-6 sm:mb-9">
        <h4 class="font-semibold text-xl mb-3 capitalize text-heading">{{ $t("menu.overview") }}</h4>
        <div class="row dashboard-overview-grid">
            <div class="col-12 sm:col-6 xl:col-3">
                <div class="dashboard-overview-card bg-admin-pink p-4 rounded-lg flex items-center gap-4">
            ...
            <div class="col-12 sm:col-6 xl:col-3">
                <div class="dashboard-overview-card bg-admin-orange p-4 rounded-lg flex items-center gap-4">
                    <div class="w-12 h-12 rounded-full flex items-center justify-center bg-white">
            ...
            <div class="col-12 sm:col-6 xl:col-3">
                <div class="dashboard-overview-card bg-admin-purple p-4 rounded-lg flex items-center gap-4">
                    <div class="w-12 h-12 rounded-full flex items-center justify-center bg-white">
            ...
            <div class="col-12 sm:col-6 xl:col-3">
                <div class="dashboard-overview-card bg-admin-blue p-4 rounded-lg flex items-center gap-4">
                    <div class="w-12 h-12 rounded-full flex items-center justify-center bg-white">
