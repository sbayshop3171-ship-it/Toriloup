<template>
    ...
    <div class="col-12">
        <div class="db-card db-tab-div active mobile-workspace-card promo-communication-card subscribers-mobile-card">
            ...
            <div class="db-table-responsive">
                <table class="db-table stripe promo-communication-table subscribers-mobile-table" id="print">
