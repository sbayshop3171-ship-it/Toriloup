        ...
        login: function () {
            try {
                ...
                this.$store.dispatch('login', payload).then((res) => {
                    ...
                    const isCustomer = roleId === this.enums.roleEnum.CUSTOMER;
                    ...
                    if (this.isAdminLoginRoute) {
                        if (isCustomer) {
                            ...
                            this.errors = {
                                validation: "Customer account cannot access admin panel."
                            };
                            return;
                        }
                    ...
                    this.errors = err?.response?.data?.errors || {
                        validation: err?.response?.data?.message || "Login failed.",
                    };
                })
            } catch (err) {
                this.loading.isActive = false;
