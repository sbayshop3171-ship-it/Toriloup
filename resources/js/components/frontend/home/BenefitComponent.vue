    ...
    <section v-if="benefits.length > 0" class="pt-8 pb-24 sm:py-12 border-t border-slate-100">
        <div class="container">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div v-for="benefit in benefits" :key="benefit.id" class="w-full max-w-[236px] relative ltr:lg:pl-9 rtl:lg:pr-9">
                    <img
                        :src="benefit.thumb"
                        alt="benefit"
                        loading="lazy"
                        decoding="async"
                        class="w-6 mb-4 lg:mb-0 lg:absolute lg:top-0 ltr:lg:left-0 rtl:lg:right-0">
