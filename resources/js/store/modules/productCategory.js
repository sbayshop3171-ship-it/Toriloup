...
export const productCategory = {
    ...
    actions: {
        ...
        export: function (context, payload) {
            return new Promise((resolve, reject) => {
                let url = 'admin/setting/product-category/export';
                if (payload) {
                    url = url + appService.requestHandler(payload);
                }
        ...
        import: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios.post('admin/setting/product-category/import/file', payload.form).then((res) => {
                    context.dispatch("lists", payload.search).then().catch();
                    resolve(res);
                }).catch((err) => {
                    reject(err);
        ...
        download: function (context, payload) {
            return new Promise((resolve, reject) => {
                let url = 'admin/setting/product-category/download-attachment';
                axios.get(url, { responseType: 'blob' }).then((res) => {
                    resolve(res);
                }).catch((err) => {
                    reject(err);
