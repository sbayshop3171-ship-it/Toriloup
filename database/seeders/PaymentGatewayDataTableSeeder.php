    ...
    public array $gateways = [
        ...
        [
            ...
            "options" => [
                [
                    "option" => 'stripe_key',
                    "value"  => 'demo_stripe_public_key',
                ],
                [
                    "option" => 'stripe_secret',
                    "value"  => 'demo_stripe_secret_key',
                ],
                [
                    "option" => 'stripe_mode',
                    "value"  => GatewayMode::SANDBOX,
        ...
        [
            ...
            "options" => [
                [
                    ...
                    "value"  => 'demo_flutterwave_public_key',
                ],
                [
                    "option" => 'flutterwave_secret_key',
                    "value"  => 'demo_flutterwave_secret_key',
                ],
                [
        ...
        [
            ...
            "options" => [
                [
                    ...
                    "value"  => 'demo_paystack_public_key',
                ],
                [
                    "option" => 'paystack_secret_key',
                    "value"  => 'demo_paystack_secret_key',
                ],
                [
